...
@section('content')
    ...
    <p class="policesnippet text-center">
        Le Hammam à un effet bénéfique sur la peau. La vapeur chaude ouvre les pores,
    ...
    <p class="policesnippet text-center">
        Le hammam est aussi appelé bain turc parles occidentaux, bain maure en référence à
        l'Espagne . Le taux d'humidité d'un Hammam se situe entre 90 et 100% . Le Hammam, symbole de la beauté à l'oriental,
        a su conquérir tous ceux et celles qui on tenté l'expérience.
    </p>
    <p class="policesnippet text-center">
        Les rituels orientaux sont des gestes de beauté. Le Hammam permet d'accéder au
        bien-être et de retrouver une peau douce grâce au savon noir et au gant de khessa. Après le hammam, dégustez un thé
        à la menthe et poursuivez l'expérience détente avec un massage de bien-être.
    </p>
