        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption d-none d-md-block text-white bg-colorcarousel">
                    <h5>Epilation</h5>
                    <p class="police-caroussel">
                        L'épilation à la cire Orientale est ancestrale et utilisée depuis Cléopâtre.
                        Ce type d'épilation est optimal et permet une repousse plus lente du poil.
                    </p>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block text-white bg-colorcarousel">
                    <h5>Epilation</h5>
                    <p class="police-caroussel">
                        Souple et malléable, la pâte s'utilise à froid. La peau est plus souple et
                        plus douce.
                    </p>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block text-white bg-colorcarousel">
                    <h5>Epilation</h5>
                    <p class="police-caroussel">
                        Épilations à la résine, Prolonger l'efficacité de l'épilation et laisser la
