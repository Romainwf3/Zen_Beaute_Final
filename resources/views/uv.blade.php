...
@section('content')
    ...
    <p class="policesnippet text-center">
        "Attention ! L'exposition aux rayonnernents d'un appareil de bronzage peut
        provoquer des cancers de la peau et des yeux et est responsable d'un vieillissement cutané prématuré.
    </p>
    <p class="policesnippet text-center">
        L'existence d'une réglementation du bronzage artificiel ne permet pas d'éliminer
        les risques sanitaires encourus en cas d'exposition, en particulier le risque de cancer.
    </p>
    <p class="policesnippet text-center">
