                    ...
                    <div class="container text-center">
                        <div class="row">
                                ...
                                <ul class="list-unstyled couleurbleu">
                                    ...
                                    <li>
                                        ...
                                        <div class="row mx-auto ">
                                            <div class="mx-auto">
                                                <img src="{{ asset('img/logo-cb.jpg') }}" alt="Logo carte bancaire">
                                                <img src="{{ asset('img/logo-mastercard.jpg') }}" alt="Logo carte Mastercard">
                                                <img src="{{ asset('img/logo-visa.jpg') }}" alt="Logo carte Visa">
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-12 mx-auto">
                                <img class="logofooter2" src="{{ asset('img/zenetbeaute.png') }}" alt="logo zen et beauté"
                                    title="Institut de beauté Sainte-Maxime">
                                <a href="https://goo.gl/maps/cbQ4PvEEq8ERSJka8">
                                    <img class="logofooter mt-4" src="{{ asset('img/devanture.jpg') }}"
