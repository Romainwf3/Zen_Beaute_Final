...
@section('content')
    ...
    <p class="policesnippet text-center">
        Le LIPOMODELAGE est efficace la ou exercice et nutrition atteignent leurs limites.
        Vous avez tout essayé pour perdre vos rondeurs disgracieuses malgré tout, votre silhouette conserve des zones
        rebelles.
    </p>
    <p class="policesnippet text-center">
        Le LIPOMODELAGE, technique issue de L'ENDERMOLOGIE est la solution aux problèmes de
        cellulite, de graisses localisées, de relâchement cutané...
    </p>
    <p class="policesnippet text-center">
        Découvrez chez Le LIPOMODELAGE, technique issue de L'ENDERMOLOGIE est la solution
        aux problèmes de cellulite de graisses localisées de relâchement cutané avec le CELLU M6 ce traitement non-invasif,
        indolore et aux effets démontrés scientifiquement.
    </p>
    <p class="policesnippet text-center">
        Pour les hommes aussi... Le LIPOMODELAGE est également efficasse sur les poignées
